...
$badwords = array(";","'","\"","*","+","union", "UNION", "del", "DEL","insert", "INSERT", "update", "UPDATE ", "drop ", "DROP ", "select", "SELECT", " memb", " MEMB", " set ", " SET ", "$","reset","whare","%");

foreach($_POST as $value)
  foreach($badwords as $word)
    if(substr_count($value, $word) > 0)
      die("AVISO!<br />Você usou caracteres inválidos, tente novamente! ");
